...
public class changeController {
    ...
    @FXML
    private TextField FIOofDoctor1;

    @FXML
    private TextField specialMarks1;
    ...
    void initialize() {
        ...
        buttonChange.setOnAction(event -> {
            ...
            try {
                ...
                dbHandler.updateMedInfo(diagnos.getText(), treatment.getText(), id, FIOofDoctor1.getText(), specialMarks1.getText());
                dbHandler.updateVisits(dateOfLastVisit.getText(), id);
                fullName.setText("");
                male.setText("");
                dateOfBirth.setText("");
                age.setText("");
                ...
                diagnos.setText("");
                treatment.setText("");
                FIOofDoctor1.setText("");
                specialMarks1.setText("");
        ...
        buttonAdd.setOnAction(event -> {
            ...
            try {
                ...
                dbHandler.insertMedInfo(diagnos.getText(), treatment.getText(), FIOofDoctor1.getText(), specialMarks1.getText() );
                dbHandler.insertVisits(dateOfLastVisit.getText());
                fullName.setText("");
                male.setText("");
                dateOfBirth.setText("");
                age.setText("");
        ...
        buttonSearch.setOnAction(event -> {
            ...
            try {
                ...
                ResultSet FIOofDoctor2 = dbHandler.selectFIOofDoctor(id);
                ResultSet specialMarks2 = dbHandler.selectSpecialMarks(id);
                ...
                FIOofDoctor1.setText(FIOofDoctor2.getString(1));
                specialMarks1.setText(specialMarks2.getString(1));

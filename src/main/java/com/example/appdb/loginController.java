...
public class loginController {
    ...
    @FXML
    private TableColumn<Patient, String> FIOofDoctor1;

    @FXML
    private TableColumn<Patient, String> specialMarks1;
    ...
    void initialize() {
        ...
        buttonShow.setOnAction(event -> {
            ...
            try {
                ...
                ResultSet FIOofDoctor2 = dbHandler.selectFIOofDoctor();
                ResultSet specialMarks2 = dbHandler.selectSpecialMarks();
                ...
                while (ids.next()) {
                    ...
                    FIOofDoctor2.next();
                    specialMarks2.next();
                    data.add(new Patient(fullNames.getString(1), males.getString(1),
                            datesOfBirths.getString(1), ages.getString(1), localities.getString(1),
                            homeAdresses.getString(1), socialStatuses.getString(1),
                            diagnoses.getString(1), lastVisitsDates.getString(1),
                            treatments.getString(1), FIOofDoctor2.getString(1), specialMarks2.getString(1), ids.getString(1)));
                }
                ...
                FIOofDoctor1.setCellValueFactory(new PropertyValueFactory<Patient, String>("FIOofDoctor"));
                specialMarks1.setCellValueFactory(new PropertyValueFactory<Patient, String>("specialMarks"));

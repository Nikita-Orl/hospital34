...
public class DatabaseHandler extends Configs {
    ...
    public  ResultSet selectSpecialMarks(String id) throws SQLException {
        Connection connection = getConnection();
        Statement statement = connection.createStatement();
        String SQL_SELECT_TASKS_DIAGNOS = "SELECT \"specialMarks\" FROM public.\"MedInfo\" WHERE \"patientId\" =" + id;
        ResultSet result = statement.executeQuery(SQL_SELECT_TASKS_DIAGNOS);

        return result;
    }

    public  ResultSet selectFIOofDoctor(String id) throws SQLException {
        Connection connection = getConnection();
        Statement statement = connection.createStatement();
        String SQL_SELECT_TASKS_DIAGNOS = "SELECT \"FIOofDoctor\" FROM public.\"MedInfo\" WHERE \"patientId\" =" + id;
        ResultSet result = statement.executeQuery(SQL_SELECT_TASKS_DIAGNOS);
    ...
    public void insertMedInfo(String diagnosis, String treatment, String FIOofDoctor, String specialMarks) throws SQLException {
        Connection connection = getConnection();
        Statement statement = connection.createStatement();
        String SQL_SELECT_TASKS_MAXPATID = "SELECT MAX(\"patientId\") FROM public.\"Patients\"";
        ResultSet result = statement.executeQuery(SQL_SELECT_TASKS_MAXPATID);
        ...
        String SQL_INSERT_TASKS_MEDINFO = "INSERT INTO public.\"MedInfo\"(\"diagnosis\", \"treatment\", \"patientId\" , \"FIOofDoctor\" , \"specialMarks\")\n" +
                "\tVALUES ('" + diagnosis + "', '" + treatment + "', " + maxPatId + ", '" + FIOofDoctor + "', '" + specialMarks + "');" ;
        System.out.println(SQL_INSERT_TASKS_MEDINFO);
        PreparedStatement preparedStatement = connection.prepareStatement(SQL_INSERT_TASKS_MEDINFO);
        preparedStatement.executeUpdate();
    }

    public void insertVisits(String lastVisitDate) throws SQLException {
        Connection connection = getConnection();
        Statement statement = connection.createStatement();
        String SQL_SELECT_TASKS_MAXPATID = "SELECT MAX(\"patientId\") FROM public.\"Patients\"";
        ResultSet result = statement.executeQuery(SQL_SELECT_TASKS_MAXPATID);
        ...
        String SQL_INSERT_TASKS_VISIT = "INSERT INTO public.\"Visits\"(\"lastVisitDate\", \"patientId\")\n" +
                "\tVALUES ('" + lastVisitDate + "', " + maxPatId + ");" ;
    ...
    public void updateMedInfo(String diagnosis, String treatment, String id, String FIOofDoctor, String specialMarks) throws SQLException {
        Connection connection = getConnection();
        String SQL_UPDATE_TASKS_MEDINFO = "UPDATE public.\"MedInfo\"\n" +
                "\tSET \"diagnosis\"='" + diagnosis + "', \"treatment\"='" + treatment + "', \"FIOofDoctor\"='" + FIOofDoctor + "', \"specialMarks\"='" + specialMarks +  "'\n" +
                "\tWHERE \"patientId\" = " + id;
        PreparedStatement preparedStatement = connection.prepareStatement(SQL_UPDATE_TASKS_MEDINFO);
        preparedStatement.executeUpdate();
    }

    public void updateVisits(String lastVisitDate, String id) throws SQLException {
        Connection connection = getConnection();
    ...
    public ResultSet selectFIOofDoctor() throws SQLException {
        Connection connection = getConnection();
        Statement statement = connection.createStatement();
        String SQL_SELECT_TASKS_DOCTORFIO = "SELECT \"FIOofDoctor\" FROM public.\"MedInfo\"";
        ResultSet result = statement.executeQuery(SQL_SELECT_TASKS_DOCTORFIO);

        return result;
    }

    public ResultSet selectSpecialMarks() throws SQLException {
        Connection connection = getConnection();
        Statement statement = connection.createStatement();
        String SQL_SELECT_TASKS_SPECIALMARKS = "SELECT \"specialMarks\" FROM public.\"MedInfo\"";
        ResultSet result = statement.executeQuery(SQL_SELECT_TASKS_SPECIALMARKS);
